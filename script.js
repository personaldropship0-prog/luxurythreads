...
function openProductPage(id) {
    ...
    prodView.style.display = 'flex'; // Centrato grazie al CSS
...
function performSearch(term) {
    if(!term) return;
    lastSearchTerm = term; // Salva per il bot
...
function openBotWithQuery() {
    toggleBot(); // Apri la chat
    // Precompila l'input con quello che stavi cercando
